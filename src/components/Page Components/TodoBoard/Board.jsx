...
const Board = () => {
    const [Todo, setTodo] = useState([
        {
            ...
            // image:"./img1.png",
            avatars: ["./img1.png", "./img4.png","./img3.png",],
            commentCount: 12,
            fileCount: 0
        },
        {
    ...
    const [InProgress, setInProgress] = useState([
        {
            ...
            // content: 'Lorem3',
            image: ["./img8.png"],
            avatars: ["./img3.png", "./img4.png", "./img1.png"],
            commentCount: 14,
            fileCount: 15
        },
        {
    ...
    const [Done, setDone] = useState([
        ...
        },
        {
            ...
            // image:"./img1.png",
            avatars: ["./img1.png", "./img3.png", "./img4.png"],
            commentCount: 12,
            fileCount: 15
        },
    ]);
